# This Makefile is for the Statistics::Gap extension to perl.
#
...
#
#   MakeMaker ARGV: (q[PREFIX=~/tools])
#
#   MakeMaker Parameters:

#     ABSTRACT_FROM => q[lib/Statistics/Gap.pm]
#     AUTHOR => q[Anagha Kulkarni <kulka020@d.umn.edu>, Guergana Savova <savova.guergana@mayo.edu>]
#     NAME => q[Statistics::Gap]
#     PREREQ_PM => { GD::Graph::colour=>q[1.1], GD::Graph::lines=>q[1.15], GD::Text=>q[0.86], GD=>q[2.19] }
#     VERSION => q[0.03]
#     VERSION_FROM => q[lib/Statistics/Gap.pm]
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Statistics/Gap.pm
...
TO_INST_PM = lib/Statistics/Gap.pm

PM_TO_BLIB = lib/Statistics/Gap.pm \
	blib/lib/Statistics/Gap.pm
...
DISTNAME = Statistics-Gap
DISTVNAME = Statistics-Gap-0.03
...
manifypods : pure_all  \
	lib/Statistics/Gap.pm \
	lib/Statistics/Gap.pm
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW)\
	  lib/Statistics/Gap.pm $(INST_MAN3DIR)/Statistics::Gap.$(MAN3EXT) 
...
realclean purge ::  clean realclean_subdirs
	...
	$(RM_RF) $(DISTVNAME)
	$(RM_F)  blib/lib/Statistics/Gap.pm $(MAKEFILE_OLD) $(FIRST_MAKEFILE)
...
metafile :
	...
	$(NOECHO) $(ECHO) 'name:         Statistics-Gap' >> META.yml
	$(NOECHO) $(ECHO) 'version:      0.03' >> META.yml
	$(NOECHO) $(ECHO) 'version_from: lib/Statistics/Gap.pm' >> META.yml
	$(NOECHO) $(ECHO) 'installdirs:  site' >> META.yml
	$(NOECHO) $(ECHO) 'requires:' >> META.yml
	$(NOECHO) $(ECHO) '    GD:                            2.19' >> META.yml
	$(NOECHO) $(ECHO) '    GD::Graph::colour:             1.1' >> META.yml
	$(NOECHO) $(ECHO) '    GD::Graph::lines:              1.15' >> META.yml
	$(NOECHO) $(ECHO) '    GD::Text:                      0.86' >> META.yml
...
$(FIRST_MAKEFILE) : Makefile.PL $(CONFIGDEP)
	...
	$(PERLRUN) Makefile.PL "PREFIX=~/tools"
...
ppd:
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>Perl extension for the "Gap Statistics"</ABSTRACT>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>Anagha Kulkarni &lt;kulka020@d.umn.edu&gt;, Guergana Savova &lt;savova.guergana@mayo.edu&gt;</AUTHOR>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <IMPLEMENTATION>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="GD" VERSION="2,19,0,0" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="GD-Graph-colour" VERSION="1,1,0,0" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="GD-Graph-lines" VERSION="1,15,0,0" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="GD-Text" VERSION="0,86,0,0" />' >> $(DISTNAME).ppd
...
pm_to_blib: $(TO_INST_PM)
	$(NOECHO) $(PERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')'\
	  lib/Statistics/Gap.pm blib/lib/Statistics/Gap.pm 
	$(NOECHO) $(TOUCH) $@
